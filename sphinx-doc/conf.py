...
# MFD-Host documentation build configuration file, created by
...
htmlhelp_basename = "mfd-host-doc"
...
latex_documents = [
    (master_doc, "mfd-host.tex", "MFD-Host Documentation", "author", "manual"),
]
...
man_pages = [(master_doc, "mfd-host", "MFD-Host Documentation", [author], 1)]
